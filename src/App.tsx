...
import PlanMyTripPage from "./pages/PlanMyTripPage"; // <<< nový import
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/ambassador-terms", element: <AmbassadorTermsPage /> },
      ...
      { path: "/plan-my-trip", element: <PlanMyTripPage /> }, // <<< nová route
